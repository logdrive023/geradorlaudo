...
export default function SettingsPage() {
  ...
  return (
    <DashboardShell>
      ...
      <Suspense fallback={<div className="flex items-center justify-center w-full h-32">Carregando...</div>}>
